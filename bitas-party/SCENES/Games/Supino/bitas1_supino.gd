...
@onready var bone_attachment_3d: BoneAttachment3D = $"NORMAL - bitas/Armature/Skeleton3D/BoneAttachment3D"

@export var bar: MeshInstance3D
@onready var animation_player: AnimationPlayer = $"NORMAL - bitas/AnimationPlayer"
...
func _process(delta: float):
	...
	if Input.is_action_just_pressed("supino_bitas_1"):
